(function () {
  ...
  function selectCity(name){inp.value=name;selectedFromList=true;hideSug();if(warnEl)warnEl.style.display='none';if(fallbackEl)fallbackEl.style.display='none';var city=name.toLowerCase().replace(/s+/g,'-');roll(mkList(city,5));}
